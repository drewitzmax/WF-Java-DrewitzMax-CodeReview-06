...
CREATE TABLE `teacher_class` (
  `idteacher_class` int(11) NOT NULL AUTO_INCREMENT,
  `teacherID` int(11) NOT NULL,
  `classID` int(11) NOT NULL,
  PRIMARY KEY (`idteacher_class`)
...
INSERT INTO `teacher_class` VALUES (1,1,1),(2,1,3),(3,2,2),(4,2,4),(5,3,1),(6,3,3),(7,4,2),(8,4,4);
